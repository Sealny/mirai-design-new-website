 ...
 * 
 * MODIFIED: Uses Mirai Design branding and content
 */
export default function EtherealBeamsHero() {
  ...
  // Get current slogans based on language
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              {/* Language switcher */}
              <div
                className="relative flex items-center space-x-1 text-white/90 cursor-pointer select-none"
                onClick={(e) => {
                  e.stopPropagation()
                  setLangOpen((o) => !o)
                }}
              ...
              >
                ...
                {langOpen && (
                  <ul
                    className="absolute top-full right-0 mt-2 py-2 px-1 rounded-xl bg-black/80 backdrop-blur-xl border border-white/10 min-w-[140px] z-50"
                    role="listbox"
                    ...
                    {availableLangs.map(({ code, label, full }) => (
                      <li
                        ...
                        className={`flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-colors ${
                          code === lang ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/5 hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.stopPropagation()
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Custom Design</div>
              </div>
              <div className="text-center">
