import { Translation } from './site/types/i18n'
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['無制限ページ', '無制限編集', 'ホスティング・SSL込み', 'SEO + データ分析', '毎月の戦略ミーティング', 'CROコンサルティング', '48時間優先サポート'],
      },
    ],
  },
...
export const translations = { en, pl, de, fr, zh, ja }
